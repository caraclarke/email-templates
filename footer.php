    ...
    <td style="padding: 20px 0px 10px 0px; text-align: center">
      ...
      <tr>
          <td style="width: 100%;font-size: 12px; font-family: sans-serif; mso-height-rule: exactly; line-height:18px; text-align: center; color: #000;">
              <span class="mobile-link--footer"><a href="">Edit your email settings</a></span> / <unsubscribe style="color:#000; text-decoration:underline;">unsubscribe</unsubscribe><br>
              <span class="mobile-link--footer">20 Park Plaza, Boston, MA 02116</span><br>
              &#169; Copyright 2016 Codiscope. All Rights Reserved.<br>
