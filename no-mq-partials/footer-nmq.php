...
echo '
  <tr>
    <td style="padding: 20px 0px 10px 0px; text-align: center; border-top: 1px solid black;">
      <div class="mktEditable" id="footerLogo"><img align="absbottom" src="http://go.codiscope.com/rs/442-XVH-714/images/color-logo.svg" height="auto" width="200" alt="" style="border-width:0;height:auto;width:100%;max-width:200px;" /></div>
    </td>
  </tr>
  <tr>
    <td style="width: 100%;font-size: 12px; mso-height-rule: exactly; line-height:18px; text-align: center; color: #000;">
      <span class=""><a href="#">Edit your email settings</a></span> /
      <a href="#" style="color:#000; text-decoration:underline;">unsubscribe</a>
      <br />
      <span class="">20 Park Plaza, Boston, MA 02116</span>
