                ...
                <table class="contents" style="border-spacing:0; color:#333333;width:100%;font-size:14px;text-align:left;" >
                  <tr>
                      <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
                          <img align="absbottom" src="http://go.codiscope.com/rs/442-XVH-714/images/typ-placeholder.png" width="100%" height="auto" alt="" style="border-width:0;max-width:400px;" />
                      </td>
                  </tr>
                </table>
              </td>
